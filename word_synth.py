...
sub_congruencies = [sub_cong, sub_incong1] #
obj_congruencies = [obj_cong, obj_incong1, obj_incong2] #
cong_lists = [sub_congruencies, obj_congruencies, ]
condition_names = ['subject_congruent', 'subject_incongruent1',] #['object_congruent', 'object_incongruent1', 'object_incongruent2','Practise'
        ...
        for sent_idx, trial_dict in enumerate(condition):   
                ...
                if not practise:
                        for cong_idx, congs in enumerate(cong_lists[cond_idx]):
                                ...
                                final_dir = os.path.join(_thisDir, 'Stimuli', 'Audio', condition_names[(3*cond_idx)+cong_idx])
                                os.chdir(final_dir)
